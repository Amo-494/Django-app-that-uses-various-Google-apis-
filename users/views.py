...
from development.mixins import(
    AjaxFormMixin,
    reCAPTCHAValidation,
    FormErrors,
    RedirectParams,
...
class SignUpView(AjaxFormMixin, FormView):
    """
    Generic FormView with our mixin for user sign-up with reCaptcha
    """   
    ...
    #over write the mixin logic to get, check and save reCAPTCHA score
